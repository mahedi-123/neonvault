...
import { Sparkles, Filter, X, Grid, List, ChevronDown, FolderOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pt-20 lg:pt-24 pb-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6 mb-12"
        ...
        >
          {categories.filter(c => c.id !== 'all').map(category => (
            <motion.a
              ...
              className="group p-6 bg-surface/50 border border-border/50 rounded-2xl hover:border-accent/30 hover:shadow-[0_20px_60px_-20px_rgba(0,255,136,0.15)] transition-all duration-300"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-display font-bold text-text">{category.name}</h3>
